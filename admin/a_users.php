    ...
    <div class="panel-body">
     <div class="row">
      ...
      <div class="form-group col-sm-4">
       ...
       <div class="input-group">
        ...
        <div class="input-group-btn">
         <button type="button" class="btn btn-info" data-show-pass="password" tabindex="-1"><span class="icon ti-key"></span></button>
        </div>
       </div>
      </div>
      <div class="form-group col-sm-4">
      ...
      <div class="form-group col-sm-4">
       ...
       <select name="group_id" id="group_id" class="form-control" data-placeholder="Group" data-allow-clear="true" requried>
