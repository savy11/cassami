<?php
 ...
 class m_ads_cat extends controller
 {
  ...
  public function select_all()
  {
   ...
   $where = "WHERE master_id='0'";
   if ($this->get('keyword') != '') {
    $where .= " AND category_name LIKE '%" . $this->replace_sql($this->get('keyword')) . "%'";
   }
   $query = "SELECT * FROM m_ads_cat {$where} ORDER BY id ASC";
