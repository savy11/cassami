<?php
 ...
 class users extends controller
 {
  ...
  public function update()
  {
   ...
   $this->db->update('users', array('first_name' => $this->post('first_name'), 'last_name' => $this->post('last_name'), 'display_name' => ($this->post('first_name') . ' ' . $this->post('last_name')), 'email' => $this->post('email'), 'password' => $this->post('password'), 'mobile_no' => $this->post('mobile_no'), 'publish' => $this->post('publish')), array('id' => $id));
  }
