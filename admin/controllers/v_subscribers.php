<?php
 ...
 class v_subscribers extends controller {
  ...
  public function __construct() {
   parent::__construct();
   $this->require_login('v-subscribers');
  }
  ...
  public function delete() {
   ...
   $this->db->delete('v_subscribers', array('id' => $this->get('id')));
  }
  ...
  public function select_all() {
   ...
   $query = "SELECT * FROM v_subscribers {$where} ORDER BY id DESC";
