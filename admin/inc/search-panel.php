<div class="panel panel-default search-panel"<?php echo $fn->get('search') == 1 ? ' style="display: block;"' : ' style="display: none;"' ?>>
    ...
    <form action="<?php echo $fn->page['url']; ?>" method="get" id="search-frm" class="form-validate">
        ...
        <div class="panel-footer">
            ...
            <a href="<?php echo $fn->page['url']; ?>" class="btn btn-default btn-sm"><i class="icon ti-arrow-left"></i> Clear Search</a>
            <button type="submit" class="btn btn-secondary btn-sm pull-right"><i class="icon ti-search"></i> Search</button>
        </div>
    </form>
</div>