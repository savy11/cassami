<?php
 ...
 $fn = new admin\controllers\m_cities;
             ...
             <div class="panel-body">
                 <div class="row">
                     <div class="form-group col-sm-4">
                         <label for="state_id" class="input-label req"><?php echo _('State'); ?></label>
                         <select name="state_id" id="<?php echo $ajax; ?>state_id" class="form-control" data-placeholder="State" data-allow-clear="true" required>
                          <?php echo $fn->show_list($fn->list['states'], $fn->post('state_id'), true); ?>
                         </select>
                     </div>
                     <div class="form-group col-sm-4">
                         <label for="city_name" class="input-label req"><?php echo _('City Name'); ?></label>
                         <input type="text" name="city_name" id="city_name" class="form-control" value="<?php echo $fn->post('city_name'); ?>" required/>
                     </div>
                     <div class="form-group col-sm-4">
