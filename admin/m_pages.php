<?php
 ...
 if ($fn->is_ajax_call()) {
  ...
  if (in_array($fn->post('action'), ['quick', 'help'])) {
   try {
    $field = $fn->post('field');
    $fn->update_field();
      ...
      <form id="data-frm" name="data-frm" method="post" class="form-validate" autocomplete="off"
          ...
          <div class="panel-body">
              <div class="row">
                  ...
                  <div class="form-group col-sm-2">
                      <label for="help_link" class="input-label req"><?php echo _('Help Link'); ?></label>
                      <select name="help_link" id="help_link" class="form-control" data-placeholder="Help Link">
                       <?php echo $fn->show_list($fn->yes_no, $fn->post('help_link'), false); ?>
                      </select>
                  </div>
                  <div class="form-group col-sm-2">
                  ...
                  <div class="form-group col-sm-6">
                   ...
                   <?php if ($fn->file_exists($fn->post('image'))) { ?>
                  ...
                  <div class="form-group col-sm-6">
                   ...
                   <?php if ($fn->file_exists($fn->post('header_image'))) { ?>
                       <div class="clearfix mt-10">
           ...
           <div class="table-responsive">
               <table class="table table-striped table-bordered">
                   ...
                   <tr>
                       ...
                       <th width="5%" class="text-center"><?php echo _('Help Link'); ?></th>
                    ...
                    foreach ($fn->data as $row) {
                     ?>
                        <tr>
                            ...
                            <td align="center">
                                <div id="help-<?php echo $row['id']; ?>">
                                 <?php echo $fn->get_view('button', 'COMMON', array('help_link' => $row['help_link'], 'field' => 'help_link', 'id' => $row['id'], 'action' => 'help')); ?>
                                </div>
                            </td>
                            <td align="center">
                            ...
                            </td><?php include 'inc/actions.php'; ?>
                        </tr>
                    <?php } ?>
                   </tbody>
               </table>
