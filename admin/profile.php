...
<div class="row">
  ...
  <form id="data-frm" name="data-frm" method="post" class="form-validate" autocomplete="off">
   <div class="panel panel-default">
    ...
    <div class="panel-footer">
     ...
     <div class="clearfix">
      <button type="submit" name="btn_update" value="update" class="btn btn-success btn-sm pull-right"><span class="icon ti-save"></span> Update</button>
     </div>
    </div>
   </div>
  </form>
 ...
 <div class="col-sm-4">
  <div class="panel panel-default">
   ...
   <div class="panel-footer">
    <div class="clearfix">
     <button type="button" class="btn btn-sm btn-warning select-image-btn"><i class="ti-upload"></i> Upload</button>
