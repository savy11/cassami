<?php
 ...
 $fn = new admin\controllers\v_subscribers;
                  ...
                  foreach ($fn->data as $row) {
                   ?>
                      <tr>
                          ...
                          <td><?php echo $fn->dt_format($row['add_date'], 'F d, Y H:i A'); ?></td>
                          <td><?php echo $row['email']; ?></td>
                          <td align="center">
                              <button type="button" class="prevent btn btn-<?php echo $fn->yes_no_label[$row['verified']]; ?>"><?php echo $fn->yes_no[$row['verified']]; ?></button>
                          </td>
