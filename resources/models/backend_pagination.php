<?php
 ...
 class backend_pagination
 {
  ...
  {
   $str = '<div class="row">';
   $str .= '<div class="col-sm-6"><div class="paging-info">' . $this->display_info() . '</div></div>';
   if ($this->link_end > $this->link_start) {
    $str .= '<div class="col-sm-6"><ul class="pagination pagination-box">' . $this->display_all() . '</ul></div>';
   }
   $str .= "</div>";
   return $str;
  }
